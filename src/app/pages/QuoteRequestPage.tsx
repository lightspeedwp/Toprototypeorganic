...
export function QuoteRequestPage() {
      ...
      <article className="wp-template-page">
        ...
        <section className="py-section-md">
          <Container maxWidth="narrow">
            <div className="text-center flex flex-col items-center gap-fluid-lg">
              ...
              <div className="flex flex-col gap-fluid-lg text-left w-full">
                <div className="flex gap-fluid-md p-element-lg rounded-[var(--radius-lg)] bg-card border border-border">
  ...
  return (
    <PageShell context="quote-request">
      ...
      <section className="py-section-md">
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-fluid-lg lg:gap-section-sm">
            {/* Form Column */}
            <div className="lg:col-span-2 flex flex-col gap-section-sm">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-fluid-lg">
                <div className="flex flex-col gap-fluid-md">
                  <h3 className="pb-element-sm border-b border-border/50 m-0 text-fluid-xl">Personal Details</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-fluid-md">
                    <div className="flex flex-col gap-fluid-xs">
                      <label className="text-fluid-sm">Full Name</label>
                      <input type="text" required placeholder="John Smith" className="w-full h-12 rounded-[var(--radius-lg)] border border-border bg-background px-element-md focus:outline-none focus:ring-2 focus:ring-primary/20" />
                    </div>
                    <div className="flex flex-col gap-fluid-xs">
                      <label className="text-fluid-sm">Email Address</label>
                      <input type="email" required placeholder="john@example.com" className="w-full h-12 rounded-[var(--radius-lg)] border border-border bg-background px-element-md focus:outline-none focus:ring-2 focus:ring-primary/20" />
                    </div>
                  </div>
                </div>

                <div className="flex flex-col gap-fluid-md">
                  <h3 className="pb-element-sm border-b border-border/50 m-0 text-fluid-xl">Trip Vision</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-fluid-md">
                    <div className="flex flex-col gap-fluid-xs">
                      <label className="text-fluid-sm">Destination</label>
                      <select required className="w-full h-12 rounded-[var(--radius-lg)] border border-border bg-background px-element-md focus:outline-none focus:ring-2 focus:ring-primary/20">
                    ...
                    <div className="flex flex-col gap-fluid-xs">
                      ...
                      <input type="date" className="w-full h-12 rounded-[var(--radius-lg)] border border-border bg-background px-element-md focus:outline-none focus:ring-2 focus:ring-primary/20" />
                    </div>
                    <div className="flex flex-col gap-fluid-xs">
                      <label className="text-fluid-sm">Number of Travelers</label>
                      <input type="number" min="1" placeholder="2" className="w-full h-12 rounded-[var(--radius-lg)] border border-border bg-background px-element-md focus:outline-none focus:ring-2 focus:ring-primary/20" />
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-fluid-xs">
                  ...
                  <textarea rows={4} placeholder="Include any special interests, dietary needs, or bucket-list sightings..." className="w-full rounded-[var(--radius-lg)] border border-border bg-background p-element-md focus:outline-none focus:ring-2 focus:ring-primary/20" />
                </div>
            ...
            {/* Sidebar Column */}
            <aside className="flex flex-col gap-section-sm">
              <div className="p-element-lg rounded-[var(--radius-xl)] bg-muted/30 border border-border/50 flex flex-col gap-fluid-lg">
                <h4 className="m-0 text-fluid-lg">Why Request a Quote?</h4>
                <ul className="flex flex-col gap-fluid-lg list-none p-0 m-0">
                  <li className="flex gap-fluid-sm m-0">
              ...
              <div className="p-element-lg rounded-[var(--radius-xl)] bg-primary text-primary-foreground relative overflow-hidden flex flex-col gap-fluid-md">
                <div className="absolute -bottom-4 -right-4 opacity-10">
                  <Phone size={120} />
                </div>
                <div className="relative z-10 flex flex-col gap-fluid-sm">
