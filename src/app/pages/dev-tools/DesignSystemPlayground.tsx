...
import { Copy, Check, Eye, Code, SlidersHorizontal } from "@phosphor-icons/react";
  ...
  return (
    <div className="bg-background text-foreground min-h-screen">
      ...
      <Container className="py-section-sm">
        <Tabs defaultValue="card" className="flex flex-col gap-8">
          ...
          <TabsContent value="card" className="flex flex-col gap-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {/* Controls */}
              <div className="bg-card p-6 rounded-lg border border-border flex flex-col gap-6">
                <div>
                  <h3 className="pb-4">Card Controls</h3>
                  
                  <div className="flex flex-col gap-4">
                    <div>
                      <label className="block pb-2">Background Color</label>
                    ...
                    <div>
                      <label className="block pb-2">Padding</label>
                    ...
                    <div>
                      <label className="block pb-2">Border Radius</label>
              ...
              <div className="bg-muted p-6 rounded-lg border border-border">
                ...
                <div className="bg-background/50 p-8 rounded-lg min-h-[400px] flex items-center justify-center">
                  ...
                  >
                    <h3>Card Title</h3>
                    <p className={bgColor === 'card' ? 'text-muted-foreground pt-2' : 'pt-2'}>
                      Card description goes here. This is how your card will look with the selected design tokens.
                    </p>
                  </div>
                </div>

                <div className="wp-bg-accent-light pt-4 p-4 rounded text-sm">
          ...
          <TabsContent value="button" className="flex flex-col gap-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-card p-6 rounded-lg border border-border flex flex-col gap-6">
                <div>
                  <h3 className="pb-4">Button Controls</h3>
                  
                  <div className="flex flex-col gap-4">
                    <div>
                      <label className="block pb-2">Variant</label>
                ...
                <div className="pt-6 border-t border-border">
                  <h4 className="pb-2">All Variants</h4>
                ...
                <div className="pt-6 border-t border-border">
                  <h4 className="pb-2">All Sizes</h4>
              ...
              <div className="bg-muted p-6 rounded-lg border border-border">
                ...
                <div className="wp-bg-accent-light pt-4 p-4 rounded text-sm flex flex-col gap-2">
          ...
          <TabsContent value="layout" className="flex flex-col gap-6">
            <div className="bg-card p-6 rounded-lg border border-border">
              <h3 className="pb-4">Common Layout Patterns</h3>
          ...
          {/* Color Tester */}
          <TabsContent value="colors" className="flex flex-col gap-6">
            <div className="bg-card p-6 rounded-lg border border-border">
              <h3 className="pb-4">Color Palette Testing</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-background text-foreground p-6 rounded-lg border border-border">
                  ...
                  <code className="text-sm pt-2 block">bg-background text-foreground</code>
                </div>
                ...
                <div className="bg-card text-card-foreground p-6 rounded-lg border border-border">
                  ...
                  <code className="text-sm pt-2 block">bg-card text-card-foreground</code>
                </div>
                ...
                <div className="bg-primary text-primary-foreground p-6 rounded-lg">
                  ...
                  <code className="text-sm pt-2 block">bg-primary text-primary-foreground</code>
                </div>
                ...
                <div className="bg-secondary text-secondary-foreground p-6 rounded-lg">
                  ...
                  <code className="text-sm pt-2 block">bg-secondary text-secondary-foreground</code>
                </div>
                ...
                <div className="bg-muted text-muted-foreground p-6 rounded-lg border border-border">
                  ...
                  <code className="text-sm pt-2 block">bg-muted text-muted-foreground</code>
                </div>
                ...
                <div className="bg-accent text-accent-foreground p-6 rounded-lg">
                  ...
                  <code className="text-sm pt-2 block">bg-accent text-accent-foreground</code>
                </div>
                ...
                <div className="bg-destructive text-destructive-foreground p-6 rounded-lg">
                  ...
                  <code className="text-sm pt-2 block">bg-destructive text-destructive-foreground</code>
                </div>
              </div>

              <div className="wp-bg-accent-light pt-8 p-4 rounded">
                <h4 className="pb-2">Accessibility Notes</h4>
